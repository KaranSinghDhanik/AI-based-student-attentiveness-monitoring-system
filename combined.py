...
if len(sys.argv) > 1:
    ...
    print("Usage: python combined.py <name>")
    sys.exit(1)
...
while True:
    ...
    if result.multi_face_landmarks:
        ...
        eye_status = f"{open_eyes}/2 Eyes Open "
    ...
    cursor.execute('''
        ...
        (name,timestamp, lip_status, eye_status, head_status, lip_score, eye_score, head_score, final_score)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    ''', (user_name,timestamp, lip_status, eye_status, head_status,
